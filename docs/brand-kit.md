...
The `docs/preview.jpg` shows these tokens applied to Frontpage's main feed view. Use it as a reference for how the brand kit comes together — it's a concept image, not a pixel-perfect spec.
