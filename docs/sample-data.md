...
| File | Format | Purpose |
|------|--------|---------|
| `data/sample-feeds.opml` | OPML 2.0 | Standard subscription import file — use for OPML import testing |
| `data/sample-feeds.json` | JSON | Same feeds in a more developer-friendly format — use for seeding |
